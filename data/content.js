      ...
      items: [
        {
          ...
          body: 'Twenty years of behaviour, no documentation, and a vendor quote priced for the risk. Code Doctor reads what is actually there.',
          points: [
            'The estate mapped from source and database, stored procedures included',
            'Intent recovered from the engineers who still hold it, one confirmation at a time',
            'An inventory you can argue with in week one, and a rulebook you own after it',
            'Equivalence proved against the original before anything is switched over',
          ],
        ...
        },
        {
          ...
          body: 'Clause creep: you strike a clause in round nineteen and it is back by round twenty-two, reworded so no summary flags it. One negotiation we sat through ran to twenty-six rounds. Contract Vetting reads a returned draft four ways at once, on any document rather than only contracts.',
          points: [
            'Against the version you agreed — what was applied, what was ignored, and what appeared that nobody asked for',
            'Against the case law and official guidance that govern the clause, with the citation attached',
            'Against the facts it asserts, checked to sources you can open',
            'Against your commercial rules: what a late payment costs, what a cap does to margin, whether it sits inside IR35',
            'And the round trip itself — send the amendments, take the reply back into the same thread, so what was agreed lives with the document',
            'Every round kept beside every other, so draft twenty-six can be read against draft one without anybody remembering the twenty-four in between',
            'And the same reading applied to a policy, a submission or a supplier response — anywhere a document has to answer to something outside itself',
          ],
        ...
        },
        {
          ...
          body: 'The work is real. The copying between systems is not. agent-stack streamlines the second without automating away the first.',
          points: [
            'You define the events; agents do the work between them',
            'A person stays in the loop wherever judgement belongs',
            'Runs last as long as the job does, not as long as a browser tab',
            'Nothing is delivered into your systems without someone opening the gate, and the record shows who opened it',
          ],
        ...
        },
        {
          ...
          body: 'Customers ask ChatGPT and Claude what to buy before they open a browser tab. shop2gpt puts your products in the answer.',
          points: [
            'Your catalogue exposed as MCP, the protocol the assistants speak',
            'Connects to the Shopify or WooCommerce store you already run',
            'Price and stock read at the moment of asking, so nothing sold out is offered',
            'Pricing and fulfilment stay yours — the assistant gets a read model and a hand-off',
          ],
        ...
        },
        {
          ...
          body: 'Each market wants its own language, its own content, and its own answer about where the data was processed. An app that cannot give all three is not deployable there. SWC is the foundation we build on, and this site runs on it — the only product demo we trust.',
          points: [
            'The locale rides the URL and the server renders in it, so each market is a real page rather than a client-side swap',
            'Right-to-left is a direction the whole component library already handles, not a retrofit — six languages ship on our own site, Arabic among them',
            'It runs at the edge, so which regions execute it is a deployment decision rather than a rewrite',
            'A hundred and three primitives and twenty full-page templates, server-rendered with no build step and no runtime dependencies',
            'Accessibility enforced by the build rather than reviewed at the end — zero WCAG 2.1 A and AA violations across sixty-two automated scans',
            'Converters bring an existing Next.js app, WordPress site or Shopify catalogue across',
          ],
        ...
        },
        {
          ...
          body: 'GDS Playground is the Lovable or Cursor of government delivery: describe the journey and watch it build.',
          points: [
            'The real GOV.UK design system, rendered through govuk-frontend itself rather than a lookalike',
            'Every project is a git repository, so a journey has history and a change has an author',
            'What you take into assessment is the thing you have been testing',
            'Runs inside your own boundary, on the model you choose',
          ],
